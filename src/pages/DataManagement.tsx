    ...
    <div className="mx-auto w-full max-w-[1600px] p-6 md:p-8">
      ...
      <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 font-bold text-slate-700 shadow-sm transition-colors hover:bg-slate-50"
          >
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left text-sm transition-colors ${
                    active
                      ? 'bg-slate-100/80 font-bold text-emerald-700'
        ...
        <div className="min-w-0 flex-1 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-100 bg-slate-50/60 px-6 py-4 text-sm font-bold text-slate-600">
